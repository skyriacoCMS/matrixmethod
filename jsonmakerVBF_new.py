...
#    print( temp ," ", i)
   ...
   # print row_index
    ...
    for i in range(0,35): 
        ...
        samplelinearcombination+=Sample("VBF", **couplings) * A_m_inv[row_index][i]
    ...
    weightt = "MC_weight_nominal*("+samplelinearcombination.weight+")"        
...
with open("testout_VBF_new.json","w") as outt:
