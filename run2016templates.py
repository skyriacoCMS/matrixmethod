...
for filename in os.listdir("/work-zfs/lhc/heshy/anomalouscouplings/step5_json/200205_2016/"):
    ...
    if ( "ggh" in filename ) and not( "Down" in filename ) and not("Dn" in filename) and not("Up" in filename) and not ("VBFtagged" in filename) and not("VHHadrtagged" in filename): 
        inputt = os.path.join("/work-zfs/lhc/heshy/anomalouscouplings/step5_json/200205_2016/", filename)
