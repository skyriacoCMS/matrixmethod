...
def jsonmaker_ggHHff(inputfile):
    ...
    #with open('templates_ggh_fa3fa2fL1fL1Zg_morecategories_2e2mu_Untagged_190703_2018.json') as f:
     ...
     for iconst in data["constraints"]:
          ...
          #     thr  =  thr + 1
          if iconst["type"] == "twoparameterHVV" and iic == 0:
               #print "here"                                                                                
               replace_names =["templateHff0MinusHVV0Plus","templateHff0MinusHVVg11g21Int","templateHff0MinusHVVg11g1prime21Int",
                          "templateHff0MinusHVV0HPlus","templateHff0MinusHVVg21g1prime21Int","templateHff0MinusHVV0L1"]


          elif  iconst["type"] == "threeparameterHVV" and iic == 0: 
               replace_names =["templateHff0MinusHVV0Plus","templateHff0MinusHVVg11g21Int","templateHff0MinusHVVg11g41IntMirror","templateHff0MinusHVVg11g1\
prime21Int","templateHff0MinusHVV0HPlus","templateHff0MinusHVVg41g21IntMirror","templateHff0MinusHVVg21g1prime21Int","templateHff0MinusHVV0Minus","templateHff0MinusHVVg41g1prime21IntMirror","templateHff0MinusHVV0L1"]

          elif iconst["type"] == "threeparameterHVV" :
               
               replace_names =["template0Plus","templateg11g21Int","templateg11g41IntMirror","templateg11g1\
prime21Int","template0HPlus","templateg41g21IntMirror","templateg21g1prime21Int","template0Minus","templateg41g1prime21IntMirror","template0L1"]
